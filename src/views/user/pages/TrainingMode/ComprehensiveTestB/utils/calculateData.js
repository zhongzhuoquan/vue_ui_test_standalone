 ...
 * @LastEditTime: 2020-12-19 10:24:09
 * @Description :
 */
export function calculateData(standardArray, testArray) {
  ...
  score_shrink = (score_shrink / scoreArray_shrink.length).toFixed(2)
  //收缩速率部分
  ...
  score_loosen = (score_loosen / scoreArray_loosen.length).toFixed(2)
  //逐渐放松
  //收缩速率部分
  for (let i = 20; i <= 40; i++) {
    if (
  ...
  //收缩高度
  array_height.push(Math.max.apply(null, testArray.slice(20, 40)))
  array_height.push(Math.max.apply(null, testArray.slice(240, 260)))
